...
import '../../../../checking/adhar_card.dart';
...
class _EventDetailState extends State<EventDetail> {
  ...
  final TextEditingController _seatLimitWomenController =
      TextEditingController(text: '50');
  final TextEditingController _minimumAgeController =
      TextEditingController(text: '18'); // Default minimum age set to 18
  ...
  Future<void> _submitForm() async {
    ...
    if (_titleController.text.isEmpty ||
        ...
        _minimumAgeController.text.isEmpty) {
    ...
    if (int.tryParse(_minimumAgeController.text) == null ||
        int.parse(_minimumAgeController.text) < 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please enter a valid minimum age.')),
      );
      return;
    }
    ...
    try {
      User userProfile = await _authService.getProfile(); // Fetch user profile
      ...
      if (userProfile.isVerified) {
        ...
        int minimumAge =
            int.parse(_minimumAgeController.text); // Get minimum age
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildTextField('Minimum Age', 'Enter minimum age',
  ...
  Widget _buildDropdownField(
      String label, String hint, List<Map<String, String>> items) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label,
